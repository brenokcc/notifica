...
class NotificacaoIndividual(models.Model):
    ...
    zona = models.ForeignKey(Zona, verbose_name='Zona', on_delete=models.CASCADE, null=True, pick=True)
    ...
    def formfactory(self):
        return (
            ...
            .fieldset('Dados Residenciais', ('pais:pais.cadastrar', ('cep', 'municipio_residencia:municipio.cadastrar'), ('distrito', 'bairro'), ('logradouro', 'codigo_logradouro'), ('numero_residencia', 'complemento'), 'zona', ('latitude', 'longitude'), 'referencia'))
