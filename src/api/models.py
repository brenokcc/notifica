...
class SolicitacaoCadastro(models.Model):
    ...
    unidade = models.ForeignKey(UnidadeSaude, verbose_name="Unidade", null=True, blank=True, help_text="Obrigatório apenas para gestor de unidade e notificante.")
...
class NotificacaoIndividual(models.Model):
    ...
    def get_status(self):
        if self.status == 'Finalizado':
            return Badge('purple', 'Finalizado')
