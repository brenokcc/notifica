...
class SolicitacoesCadastroNotificante(
    endpoints.ListEndpoint[SolicitacaoCadastroNotificante]
):
    class Meta:
    ...
    def get(self):
        return (
            ...
            .filters("aprovada")
            .actions(
                "solicitacaocadastronotificante.cadastrar",
                "solicitacaocadastronotificante.visualizar",
                "solicitacaocadastronotificante.avaliar",
                "solicitacaocadastronotificante.excluir",
            )
        )
...
class Avaliar(endpoints.InstanceEndpoint[SolicitacaoCadastroNotificante]):
    ...
    def get(self):
        return super().formfactory().fields("aprovada", "observacao")
